...
function Projects(){
	return(
		<div className='topDiv'>
			...
			<div className='flexBox'>
				<span className='flex-item' >
					<a href='https://stormy-badlands-58815.herokuapp.com/'>
						<img src='http://i.imgur.com/y1QwjDv.png'/>
					</a>
				...
				<span className='flex-item' >
					<a href='https://murmuring-bastion-36829.herokuapp.com/'>
						<img src='http://i.imgur.com/Lp429eX.png'/>
					</a>
				...
				<span className='flex-item' >
					<a href='https://fast-brushlands-52388.herokuapp.com/'>
						<img src='http://i.imgur.com/uRdSoKO.png'/>
					</a>
					<h3>Book Trading</h3>
			...
			<div className='flexBox'>
				<span className='flex-item'>
					<a href='https://lesteven.github.io/roguelike/'>
						<img src='http://i.imgur.com/h0NYaQQ.png'/>
					</a>
					<h3>Roguelike</h3>
				...
				<span className='flex-item'>
					<a href='https://lesteven.github.io/gameoflifev2/'>
						<img src='http://i.imgur.com/N6BJum3.png'/>
					</a>
					<h3>Game of Life</h3>
					<p>Tech: React</p>
			...
			<div className='flexBox'>
				<span className='flex-item'>
					<a><img src='http://i.imgur.com/IKNJ8Jk.png'/></a>
					<h3>Heatmap</h3>
					<p>Tech: D3</p>
					<p>Heat map of land temperature.</p>
				</span>
				<span className='flex-item'>
					<a><img src='http://i.imgur.com/CQvabhw.png'/></a>
					<h3>Globe</h3>
					<p>Tech: D3</p>
